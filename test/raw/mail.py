...
def send_email():
    ...
    # 本次测试结果附件
    part = MIMEApplication(open(os.path.join(Consts.SESSIONS_PATH, 'History Sessions',
                                             Consts.ZIP_NAME), 'rb').read())
    part.add_header('Content-Disposition', 'attachment', filename=urllib.request.quote(Consts.ZIP_NAME))
